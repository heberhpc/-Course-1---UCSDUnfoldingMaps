 ...
 * Date: July 17, 2015
 * */
public class EarthquakeCityMap_v2 extends PApplet {
	...
	public void setup() {		
		...
		if (offline) {
			...
			map = new UnfoldingMap(this, 200, 50, 650, 600, selectProvider(6));
	    ...
	    for(PointFeature feature : earthquakes) {
		  ...
		  if(isLand(feature)) {
		   ...
		   // System.out.println("Is in Land");
		  }
		  // OceanQuakes
		  else {
		    quakeMarkers.add(new OceanQuakeMarker(feature));
		    //System.out.println("Is in Ocean");
		  }
	    }
	    ...
	    personalizeMarkers(quakeMarkers);
	...
	private void addKey() {	
		...
		float tSize = 15;
		float pointTX1 = x;
		float pointTY1 = y-(tSize/2);
		float pointTX2 = x-(tSize/3);
		float pointTY2 = y;
		float pointTX3 = x+(tSize/3);
		float pointTY3 =  y;
		fill(color(255,0,0));
		triangle(pointTX1,pointTY1,pointTX2,pointTY2,pointTX3,pointTY3);
		fill(0);
		text("Cities", x+15, y-5);
		
		fill(255);
		stroke(0);
		ellipse(x,y+15, 15,15);
		fill(0);
		text("Land Quake", x+15, y+15);
		
		fill(255);
		stroke(0);
		rect(x-5,y+30, 15,15);
		fill(0);
		text("Ocean Quake", x+15, y+35);
		
		fill(0);
		text("Size ~ Magnitude", x, y+60);
		
		fill(0);
		text("How Deep",x,y+85);
		
		fill(color(255,255,00));
		ellipse(x, y+110, 15,15);
		fill(0);
		text("Shallow:0-70 km",x+15,y+110);
		
		fill(color(0,0,255));
		ellipse(x, y+130, 15,15);
		fill(0);
		text("Interm.:70-300 km",x+15,y+130);
		
		fill(color(255,0,0));
		ellipse(x, y+150, 15,15);
		fill(0);
		text("deep:300-700 km",x+15,y+150);
	...
	private void personalizeMarkers(List<Marker> ListOfMarkers) {
