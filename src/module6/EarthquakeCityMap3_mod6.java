 ...
 * Date: July 17, 2015
 * */
public class EarthquakeCityMap3_mod6 extends PApplet {
	...
	public void mouseClicked() {
		...
		System.out.println("The lastClicked" + lastClicked);
		...
		if (lastClicked == null) {
			...
			System.out.println("The lastClicked is not null, hidenn marks" + lastClicked);
			hidedMarks() ;
		}
	}
	...
	private void selectMarkerIfClicked(List<Marker> markers) {
		...
		System.out.println("selectMarkerIfClicked");
		for (Marker m: markers) {
